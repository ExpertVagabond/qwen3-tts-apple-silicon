#!/usr/bin/env python3
"""Generate Schneider interview answers using Matthew's cloned voice via Qwen3-TTS."""
...
def main():
    ...
    # Concatenate each question's segments into a single file
    ...
    if all_m4as:
        ...
        full_output = os.path.join(OUTPUT_DIR, "schneider-full-practice-matthew.m4a")
        cmd = [
            "ffmpeg", "-y", "-f", "concat", "-safe", "0",
            "-i", full_concat,
